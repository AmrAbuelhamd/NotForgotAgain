...
import kotlinx.android.synthetic.main.fragment_notes_board.view.*
 ...
 * Use the [NotesBoardFragment.newInstance] factory method to
...
class NotesBoardFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val view =  inflater.inflate(R.layout.fragment_notes_board, container, false)

        view.addNoteFloatingActionButton.setOnClickListener{
...
//            startActivity(intent)
        ...
        val recyclerView = view.notesRecycler.apply {
    ...
    companion object {
         ...
         * @return A new instance of fragment NotesBoardFragment.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            NotesBoardFragment().apply {
